...
class TeamAthleteGoalZoneBreakdownSection extends StatefulWidget {
  ...
  const TeamAthleteGoalZoneBreakdownSection({
    super.key,
  ...
  @override
  State<TeamAthleteGoalZoneBreakdownSection> createState() =>
      _TeamAthleteGoalZoneBreakdownSectionState();
}

class _TeamAthleteGoalZoneBreakdownSectionState
    extends State<TeamAthleteGoalZoneBreakdownSection> {
  final _repository = TeamAthleteGoalZoneBreakdownRepository();
