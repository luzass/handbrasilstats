class MatchGoalZoneBreakdownModel {
  ...
  const MatchGoalZoneBreakdownModel({
  ...
  factory MatchGoalZoneBreakdownModel.fromMap(Map<String, dynamic> map) {
    return MatchGoalZoneBreakdownModel(
